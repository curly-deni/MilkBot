...
class ArtifactPreview(BaseWikiPreview):
    ...
    def __group_effects(
        ...
        values["effects"] = {
            amount: effect for amount, effect in effects.items() if effect
        }
        return values
...
class EnemyPreview(BaseWikiPreview):
    ...
    def __parse_drop_materials(
        cls, value: typing.Union[str, typing.Sequence[str]]
    ) -> typing.Sequence[str]:
    ...
    def __format_modules(
        ...
        for module in value:
            components: typing.Dict[str, typing.Dict[str, typing.Any]] = {
                component["component_id"]: json.loads(component["data"])
            ...
            if "reliquary_set_effect" in components:
                ...
                components["baseInfo"]["reliquary_set_effect"] = components.pop(
