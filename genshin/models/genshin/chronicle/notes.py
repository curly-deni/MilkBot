...
def _process_timedelta(
    time: typing.Union[int, datetime.timedelta, datetime.datetime]
) -> datetime.datetime:
...
class Notes(APIModel):
    ...
    remaining_realm_currency_recovery_time: datetime.timedelta = Aliased(
    ...
    def realm_currency_recovery_time(self) -> datetime.datetime:
        ...
        return (
            ...
            + self.remaining_realm_currency_recovery_time
        )
