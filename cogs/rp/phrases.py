...
alone: str = "Любите себя, это так важно! :heart:"

smile_phrases: list[str] = [
    "Поздравляю, мы только что увидели совершенство!",
    "Слишком идеально, Гугл",
    "Окей, Гугл, где найти идеал?",
]

poke_phrases: list[str] = ["А тыколка не отвалится?", "Ну ладно...", "Он умер в конце"]

slap_phrases: list[str] = [
    "Опупел",
    "Семпай, прекрати",
