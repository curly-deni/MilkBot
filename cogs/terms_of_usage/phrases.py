...
user_terms: dict = {
    "Пользовательское cоглашение": """Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между владельцем http://milkbot.dan-mi.ru (далее MilkBot или Администрация) и бота MilkBot#4867 с одной стороны и пользователем сайта с другой.
