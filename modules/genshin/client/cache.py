...
class Cache(BaseCache):
    ...
    def __init__(
        self, maxsize: int = 1024, *, ttl: float = HOUR, static_ttl: float = DAY
    ) -> None:
        self.cache = {}
...
class RedisCache(BaseCache):
    ...
    def __init__(
        self, redis: aioredis.Redis, *, ttl: int = HOUR, static_ttl: int = DAY
    ) -> None:
        self.redis = redis
        self.ttl = ttl
        self.static_ttl = static_ttl
    ...
    async def get(self, key: typing.Any) -> typing.Optional[typing.Any]:
        """Get an object with a key."""
        value: typing.Optional[bytes] = await self.redis.get(
