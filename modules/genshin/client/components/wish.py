...
from modules.genshin.models.genshin import wish as models
...
class WishClient(base.BaseClient):
    ...
    async def _get_wish_page(
        ...
        *,
        ...
        return [
            models.Wish(**i, banner_name=banner_names[banner_type])
            for i in data["list"]
        ]
    ...
    def wish_history(
        ...
        *,
        ...
        return paginators.MergedPaginator(
            iterators, key=lambda wish: wish.time.timestamp()
        )
    ...
    async def get_banner_names(
        ...
        *,
        ...
        data = await self.request_gacha_info(
            ...
            lang=lang,
            authkey=authkey,
            static_cache=client_cache.cache_key(
                "banner", endpoint="names", lang=lang or self.lang
            ),
        )
        ...
        *,
        ...
        data = await self.request_webstatic(
            ...
            cache=client_cache.cache_key(
                "banner", endpoint="details", banner=banner_id, lang=lang
            ),
        )
