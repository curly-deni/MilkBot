...
from modules.genshin.models.honkai import chronicle as models
...
class HonkaiBattleChronicleClient(base.BaseBattleChronicleClient):
    ...
    async def get_honkai_battlesuits(
        ...
        *,
        ...
        return [
            models.FullBattlesuit(**char["character"]) for char in data["characters"]
        ]
    ...
    async def get_honkai_old_abyss(
        ...
        *,
        ...
        return [
            models.OldAbyss(**x, abyss_lang=lang or self.lang) for x in data["reports"]
        ]
    ...
    async def get_honkai_superstring_abyss(
        ...
        *,
        ...
        return [
            models.SuperstringAbyss(**x, abyss_lang=lang or self.lang)
    ...
    async def get_honkai_memorial_arena(
        ...
        *,
        ...
        return [
            models.MemorialArena(**x, ma_lang=lang or self.lang)
            for x in data["reports"]
        ]
