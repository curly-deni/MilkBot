...
from modules.genshin import errors, models, types
from modules.genshin.client import cache, manager, routes
from modules.genshin.client.components import base
from modules.genshin.models import hoyolab as hoyolab_models
...
class BaseBattleChronicleClient(base.BaseClient):
    ...
    async def request_game_record(
        ...
        **kwargs: typing.Any,
        ...
        mi18n_task = asyncio.create_task(
            self._fetch_mi18n("bbs", lang=lang or self.lang)
        )
    ...
    async def get_record_cards(
        ...
        *,
        ...
        cache_key = cache.cache_key(
            "records", hoyolab_uid=hoyolab_uid, lang=lang or self.lang
        )
    ...
    async def set_visibility(
        self, public: bool, *, game: typing.Optional[types.Game] = None
    ) -> None:
