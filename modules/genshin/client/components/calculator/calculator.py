...
T = typing.TypeVar("T")
CallableT = typing.TypeVar(
    "CallableT", bound="typing.Callable[..., typing.Awaitable[object]]"
)
...
def _cache(func: CallableT) -> CallableT:
    ...
    async def wrapper(
        self: CalculatorState, *args: typing.Any, **kwargs: typing.Any
    ) -> typing.Any:
...
class ArtifactResolver(
    CalculatorResolver[typing.Sequence[typing.Mapping[str, typing.Any]]]
):
...
class Calculator:
    ...
    def set_artifact_set(
        self, any_artifact_id: int, current: int, target: int
    ) -> Calculator:
        """Set an artifact set."""
