...
class GenshinClient(clients.Client):
    ...
    def cookies(self) -> typing.Mapping[str, str]:
        ...
        deprecation.warn_deprecated(
            self.__class__.cookies, alternative="cookie_manager"
        )
    ...
    def cookies(self, cookies: typing.Mapping[str, typing.Any]) -> None:
        deprecation.warn_deprecated(
            "Setting cookies with GenshinClient.cookies", alternative="set_cookies"
        )
    ...
    def uid(self) -> typing.Optional[int]:
        deprecation.warn_deprecated(
            self.__class__.uid, alternative="Client.uids[genshin.Game.GENSHIN]"
        )
