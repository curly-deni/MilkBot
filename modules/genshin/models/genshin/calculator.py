...
class CalculatorTalent(APIModel, Unique):
    ...
    def type(self) -> typing.Literal["attack", "skill", "burst", "passive", "dash"]:
        ...
        if identifier == 2:
            ...
            raise ValueError(
                f"Cannot parse type for talent {self.group_id!r} (group {group})"
            )
...
class CalculatorCharacterDetails(APIModel):
    ...
    def __correct_talent_current_level(
        cls, v: typing.Sequence[CalculatorTalent]
    ) -> typing.Sequence[CalculatorTalent]:
...
class CalculatorResult(APIModel):
    ...
    def total(self) -> typing.Sequence[CalculatorConsumable]:
        ...
        grouped: typing.Dict[
            int, typing.List[CalculatorConsumable]
